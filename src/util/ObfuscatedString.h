...
namespace utl {
	...
	*/
	...
	public:
		...
		*/
		size_t find(const char ch) const noexcept;
		...
		*/
		inline size_t size() const noexcept { return _obfuscated_text.size(); }

		/**
		 * Returns the length of the string.
		*/
		inline size_t length() const noexcept { return _obfuscated_text.length(); }
		...
		*/
		inline char operator[](size_t pos) const noexcept { return decode(_obfuscated_text[pos], _key); }
		...
		*/
		std::string uncrypt() const noexcept;
