...
namespace aux {
	...
	*/
	...
	public:
		...
		/**
		 * Returns the registry value as a dword.
		 * 
		 * The method raises a system_error exception
		 * if the key does not exist or is not a dword.
		*/
		DWORD get_word(const std::wstring& value_name) const;

		/**
		 * Returns the value as a dword.
		 *
		 * The function returns the default value If the key name does not exist.
		 * The method raises a system_error exception if the key is not a dword.
		*/
		...
		/**
		 * Returns the registry value as a string.
		 *
		 * The method raises a system_error exception
		...
		*/
		 ...
		 *
		 * The function returns the default value If the key name does not exist.
		 * The method raises a system_error exception if the key is not a string.
		*/
