...
namespace http {
	...
	utl::obfstring Cookie::to_header() const
	{
		return utl::obfstring{ _name + "=" }.append(_value);
	}
	...
	Cookie Cookie::parse(const utl::obfstring& cookie_string)
	{
		std::vector<utl::obfstring> parts;
