...
/**
* \def MBEDTLS_HAVE_ASM (>> Enabled/Default)
*
...
/**
* \def MBEDTLS_NO_UDBL_DIVISION (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_NO_64BIT_MULTIPLICATION (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_HAVE_SSE2 (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_HAVE_TIME (>> Enabled/Default)
*
...
/**
* \def MBEDTLS_HAVE_TIME_DATE (>> Enabled/Default)
*
...
/**
* \def MBEDTLS_PLATFORM_MEMORY (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_PLATFORM_NO_STD_FUNCTIONS (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_PLATFORM_EXIT_ALT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_DEPRECATED_WARNING (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_DEPRECATED_REMOVED (>> Enabled/Updated)
*
...
/**
* \def MBEDTLS_TIMING_ALT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_AES_ALT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SHA256_PROCESS_ALT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_ECP_INTERNAL_ALT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_ENTROPY_HARDWARE_ALT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_AES_ROM_TABLES (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_AES_FEWER_TABLES (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_CAMELLIA_SMALL_MEMORY (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_CHECK_RETURN_WARNING (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_CIPHER_MODE_CBC  (>> Disabled/Updated)
*
...
/**
* \def MBEDTLS_CIPHER_MODE_CFB  (>> Disabled/Updated)
*
...
/**
* \def MBEDTLS_CIPHER_MODE_CTR  (>> Disabled/Updated)
*
...
/**
* \def MBEDTLS_CIPHER_MODE_OFB  (>> Disabled/Updated)
*
...
/**
* \def MBEDTLS_CIPHER_MODE_XTS  (>> Disabled/Updated)
*
...
/**
* \def MBEDTLS_CIPHER_NULL_CIPHER (>> Disabled/Default)
*
* Enable NULL cipher.
...
/** \def MBEDTLS_CTR_DRBG_USE_128_BIT_KEY (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_ECP_RESTARTABLE (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_ECDSA_DETERMINISTIC (>> Enabled/Default)
*
...
/**
* \def MBEDTLS_NO_DEFAULT_ENTROPY_SOURCES (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_NO_PLATFORM_ENTROPY (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_ENTROPY_FORCE_SHA256 (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_ENTROPY_NV_SEED (>> Disabled/Default)
*
...
/* MBEDTLS_PSA_CRYPTO_KEY_ID_ENCODES_OWNER (>> Disabled/Default)
*
...
/** \def MBEDTLS_PSA_CRYPTO_BUILTIN_KEYS (>> Disabled/Default)
*
...
/** \def MBEDTLS_PSA_CRYPTO_DRIVERS (>> Disabled/Default)
*
...
/** \def MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_PSA_CRYPTO_SPM (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_PSA_INJECT_ENTROPY (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_RSA_NO_CRT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SELF_TEST (>> Enabled/Default)
*
...
/**
* \def MBEDTLS_SHA256_SMALLER (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SHA512_SMALLER (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SSL_DTLS_CONNECTION_ID (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SSL_ASYNC_PRIVATE (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SSL_DEBUG_ALL (>> Disabled/Default)
*
...
/** \def MBEDTLS_SSL_ENCRYPT_THEN_MAC (>> Disabled/Updated)
*
...
/** \def MBEDTLS_SSL_EXTENDED_MASTER_SECRET (>> Disabled/Updated)
*
...
/**
* \def MBEDTLS_SSL_PROTO_TLS1_2 (>> Disabled/Updated)
*
...
*/
//fortirdp #define MBEDTLS_SSL_PROTO_TLS1_2

/**
* \def MBEDTLS_SSL_PROTO_TLS1_3 (>> Enabled/Updated)
*
...
/**
* \def MBEDTLS_SSL_TLS1_3_COMPATIBILITY_MODE (>> Enabled/Updated)
*
...
/**
* \def MBEDTLS_SSL_PROTO_DTLS (>> Disabled/Updated)
*
...
*/
//fortirdp #define MBEDTLS_SSL_PROTO_DTLS
...
/**
* \def MBEDTLS_SSL_DTLS_ANTI_REPLAY (>> Disabled/Updated)
*
...
/**
* \def MBEDTLS_SSL_DTLS_HELLO_VERIFY  (>> Disabled/Updated)
*
...
/**
* \def MBEDTLS_SSL_DTLS_SRTP (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SSL_DTLS_CLIENT_PORT_REUSE (>> Disabled/Updated)
*
...
/**
* \def MBEDTLS_TEST_CONSTANT_FLOW_MEMSAN (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_TEST_CONSTANT_FLOW_VALGRIND (>> Disabled/Default)
*
* Enable testing of the constant-flow nature of some sensitive functions with
...
/**
* \def MBEDTLS_TEST_HOOKS (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_THREADING_ALT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_THREADING_PTHREAD (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_USE_PSA_CRYPTO (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_PSA_CRYPTO_CONFIG (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_X509_REMOVE_INFO (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_MD5_C (>> Disabled/Updated)
*
...
*
*/
//fortirdp #define MBEDTLS_MD5_C

/**
* \def MBEDTLS_MEMORY_BUFFER_ALLOC_C (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_NET_C (>> Enabled/Default)
*
...
/**
* \def MBEDTLS_PSA_CRYPTO_C (>> Enabled/Default)
*
...
/**
* \def MBEDTLS_PSA_CRYPTO_SE_C (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SHA1_C (>> Disabled/Updated)
*
...
*
*/
//fortirdp #define MBEDTLS_SHA1_C
...
/**
* \def MBEDTLS_SHA256_USE_A64_CRYPTO_IF_PRESENT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SHA256_USE_A64_CRYPTO_ONLY (>> Disabled/Default)
*
* Enable acceleration of the SHA-256 and SHA-224 cryptographic hash algorithms
...
/**
* \def MBEDTLS_SHA512_USE_A64_CRYPTO_IF_PRESENT (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_SHA512_USE_A64_CRYPTO_ONLY (>> Disabled/Default)
*
* Enable acceleration of the SHA-512 and SHA-384 cryptographic hash algorithms
* with the ARMv8 cryptographic extensions, which must be available at runtime
* or else an illegal instruction fault will occur.
...
/**
* \def MBEDTLS_SSL_SRV_C (>> Disabled/Updated)
*
...
*/
//fortirdp #define MBEDTLS_SSL_SRV_C
...
/**
* \def MBEDTLS_THREADING_C (>> Disabled/Default)
*
...
/**
* \def MBEDTLS_PSA_CRYPTO_CONFIG_FILE (>> Disabled/Default)
*
* If defined, this is a header which will be included instead of
* `"psa/crypto_config.h"`.
...
/**
* \def MBEDTLS_PSA_CRYPTO_USER_CONFIG_FILE (>> Disabled/Default)
*
* If defined, this is a header which will be included after
